...
class GameModel: NSObject {
    ...
    fileprivate var moveHistory: [(move: PlayerInGameMove, player: PlayerModel)]
    
    init(homeTeam: TeamModel, awayTeam: TeamModel, identifier: String) {
    ...
    func addPlayerMove(_ move: PlayerInGameMove, for player: PlayerModel) {
    ...
    func playerMoveCount(for player: PlayerModel, move: PlayerInGameMove) -> UInt {
    ...
    fileprivate func containsPlayer(_ player: PlayerModel) -> Bool {
        var contains = false
    ...
    fileprivate func updateMoveHistory(with move: PlayerInGameMove, player: PlayerModel) {
        moveHistory.append((move: move, player: player))
    }
    
    fileprivate func updateScore(_ score: UInt, withScoringPlayer player: PlayerModel) {
