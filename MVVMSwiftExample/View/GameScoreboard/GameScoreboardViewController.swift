...
class GameScoreboardViewController: UIViewController {
    
    @IBOutlet weak var homePlayer1View: PlayerScoreboardView!
    @IBOutlet weak var homePlayer2View: PlayerScoreboardView!
    @IBOutlet weak var homePlayer3View: PlayerScoreboardView!
    
    @IBOutlet weak var awayPlayer1View: PlayerScoreboardView!
    @IBOutlet weak var awayPlayer2View: PlayerScoreboardView!
    @IBOutlet weak var awayPlayer3View: PlayerScoreboardView!
    ...
    //this allows a viewmodel to be assigned to the controller before the UI is loaded e.g refer to viewDidLoad also calls fillUI
    //useful for using the controller with a different viewmodel instance elsewhere perhaps!
    var viewModel: GameScoreboardViewModelProtocol? {
        didSet {
            fillUI()
        }
    }
