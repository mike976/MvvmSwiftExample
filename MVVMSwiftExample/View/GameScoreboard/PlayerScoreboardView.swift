...
//Supplemented with Interface Builder view in PlayerScoreboardView.xib
//Subview of the above view, also uses MVVM design pattern.

//UIView for the playerScoreView Custom Cell/View

import UIKit

class PlayerScoreboardView: UIView {
    ...
    var viewModel: PlayerScoreboardViewModelProtocol? {
        didSet {
            fillUI()
        }
    }
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        let playerView: UIView = UINib.loadPlayerScoreboardView(self)
